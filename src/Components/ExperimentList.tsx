...
const data = [
    ...
    {  
      "id": "grass",
      "link": "../grass/index.html"
    },
    {  
      "id": "self-portraits",
      "link": "../self-portraits/index.html"
    },
    {  
      "id": "life-mask",
      "link": "../life-mask/index.html"
    },
    {  
      "id": "three-portraits",
      "link": "../three-portraits/index.html"
    },
    {  
      "id": "dyer",
      "link": "../dyer/index.html"
    },
    {  
      "id": "man-with-monkey",
      "link": "../man-with-monkey/index.html"
    },
    {  
      "id": "three-studies",
      "link": "../three-studies/index.html"
    },
    {  
      "id": "bull-death",
      "link": "../bull-death/index.html"
    }
  ]
                ...
                if(thumbs !== void 0){
                    for(let i=0; i<thumbs.length; i++){
                        thumbs[i].addEventListener(
                            "click",
                            (event: Event) => {
                                const   frame = document.getElementById("content-iframe") as HTMLIFrameElement,
    ...
    render(): React.ReactNode {
        return(
            <Thumbnails id="thumbnails">
                {data.map(item => (
                    <Thumbnail key={item.id} id={item.id} className="thumbnail" data-src={item.link}></Thumbnail>
                ))}
            </Thumbnails>           
        )
    }
